...
func Test_openapi_DefaultApiService(t *testing.T) {
    ...
    t.Run("Test DefaultApiService DeleteTodo", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.DefaultApi.DeleteTodo(context.Background()).Execute()
    ...
    t.Run("Test DefaultApiService GetTodos", func(t *testing.T) {

        t.Skip("skip test")  // remove to run test

        resp, httpRes, err := apiClient.DefaultApi.GetTodos(context.Background()).Execute()
